...
async function executeSellLogic() {
...
// Run the sell logic periodically (or trigger on specific event)
executeSellLogic().catch((error) => console.error("Error executing sell logic:", error));